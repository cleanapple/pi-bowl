...
def correct():
	global scores, buzzedIn, plus10, question, wrongLimit, firstWrong

	scores[buzzedIn][question].config(bg="#77ff77")
	setLabel(scores[buzzedIn][question], "+1")
	wrongLimit=0
	changeQuestion(1)
...
def wrong():
	global timeLeft, locked, timestart, state, timing, timeString, minus5, \
		deciding, buzzedIn, TIMELIMIT, interrupted, firstWrong, wrongLimit, scores, question, buzzable
